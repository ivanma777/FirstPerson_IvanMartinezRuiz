...
public class ArmaAutomatica : MonoBehaviour
{
    ...
    [SerializeField] private GameObject disminucionRecarga;
    ...
    private IEnumerator DelayedAction()
    {
        ...
        yield return new WaitForSeconds(2f / velocidadActual);
    ...
    private void PerkCadencia()
    {
        if (disminucionRecarga.activeSelf)
        {
            velocidadActual = 2f;
